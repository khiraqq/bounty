    ...
    <>
      ...
      <nav className="bg-nav border-b border-border sticky top-0 z-40">
        <div className="mx-auto flex max-w-7xl items-center gap-1 px-4 py-2.5">
          {/* Logo */}
          <Link href="/" className="shrink-0 font-black text-2xl text-foreground mr-6" style={{ fontFamily: "'Doto', sans-serif", letterSpacing: '-0.02em' }}>
            Bounty
          </Link>
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="hidden lg:flex items-center rounded-lg border border-border bg-secondary px-3 py-1.5 gap-2 w-48 focus-within:border-foreground/30 transition-colors">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-muted-foreground shrink-0"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
              <input
                type="text"
            ...
            <div id="auth-buttons" className="flex items-center gap-2">
              <button onClick={() => window.openModal?.('login')}
              ...
              <button onClick={() => window.openModal?.('signup')}
              ...
              <div className="relative">
                ...
                <div id="profile-dropdown" className="hidden absolute right-0 top-full mt-2 w-56 rounded-xl border border-border bg-card shadow-2xl z-50 overflow-hidden">
                  ...
                  <div className="flex gap-2 px-3 py-2 border-b border-border">
                    <Link href="/deposit" className="flex-1 text-center text-xs font-semibold py-1.5 rounded-lg bg-foreground text-background hover:opacity-80 transition-opacity">Deposit</Link>
                    <button className="flex-1 text-xs font-semibold py-1.5 rounded-lg border border-border hover:bg-secondary transition-colors">Withdraw</button>
                  </div>
                  <div className="py-1">
                    {[
                  ...
                  <div className="border-t border-border py-1">
                    <button onClick={() => { window.logout?.(); window.closeProfileDropdown?.(); }}
      ...
      <div id="modal-overlay" className="hidden fixed inset-0 z-50 items-center justify-center" onClick={e => window.handleOverlayClick?.(e)}>
        ...
        <div className="relative z-10 w-full max-w-md mx-4 rounded-2xl p-8 shadow-2xl border border-border" style={{ background: "hsl(var(--card))", borderColor: "hsl(var(--border))" }} onClick={e => e.stopPropagation()}>
          ...
          <div id="login-modal">
            ...
            <p className="text-center text-sm mt-5" style={{ color: 'hsl(var(--muted-foreground))' }}>
              ...
              <button type="button" onClick={() => window.switchView?.('signup')} className="font-bold underline underline-offset-2 hover:opacity-70" style={{ color: 'hsl(var(--foreground))' }}>Sign up</button>
            </p>
          </div>
          ...
          <div id="signup-modal" className="hidden">
            ...
            <form id="signup-form" className="space-y-3" onSubmit={e => window.handleSignupSubmit?.(e)}>
              <div>
                <label className="text-sm font-medium block mb-1.5">Username</label>
                <input id="signup-username" type="text" placeholder="Your username" autoComplete="username"
                  className="w-full h-10 px-3 rounded-lg bg-background border border-input text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring" />
              </div>
              <div>
              ...
              <div>
                ...
                <input id="signup-confirm-password" type="password" placeholder="Repeat password" autoComplete="new-password"
                  className="w-full h-10 px-3 rounded-lg bg-background border border-input text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring" />
              </div>
            ...
            <p className="text-center text-sm mt-5" style={{ color: 'hsl(var(--muted-foreground))' }}>
              ...
              <button type="button" onClick={() => window.switchView?.('login')} className="font-bold underline underline-offset-2 hover:opacity-70" style={{ color: 'hsl(var(--foreground))' }}>Login</button>
            </p>
          </div>
        </div>
      </div>
