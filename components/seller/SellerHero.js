...
export default function SellerHero({ onStartSelling }) {
  ...
  return (
    <section className="relative min-h-[520px] flex flex-col overflow-hidden bg-[hsl(var(--background))]">
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto max-w-7xl w-full px-6 mt-10"
      >
        <div className="flex flex-wrap gap-3">
          {STATS.map((s, i) => (
            <motion.div
              ...
              className="flex flex-col px-5 py-3 rounded-2xl border border-border bg-secondary"
              style={{ minWidth: 170 }}
            >
